...
public class SinhVienDB {
    ...
    public List<SinhVien> getAllActive() {
        ...
        String sql = """
            SELECT MaSV, HoTen, NgaySinh, GioiTinh, DiaChi, SoDienThoai, MaLop, TenDangNhap
            FROM SinhVien
    ...
    public boolean insert(SinhVien sv) {
        ...
        String sql = """
            INSERT INTO SinhVien (MaSV, HoTen, NgaySinh, GioiTinh, DiaChi, SoDienThoai, MaLop, TenDangNhap, TrangThai)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, N'Đang học')
        """;
        try (Connection con = DBConnection.getConnection();
             PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public boolean update(SinhVien sv) {
        String sql = """
            UPDATE SinhVien
            SET HoTen=?, NgaySinh=?, GioiTinh=?, DiaChi=?, SoDienThoai=?, MaLop=?, TenDangNhap=?
            WHERE MaSV=?
        """;
